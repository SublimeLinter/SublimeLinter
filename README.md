...
Want to see actions for your favourite linter? Please open an issue so we can investigate it. Eventually, as this feature becomes more stable, we will expose it as an API so that plugins can add their own actions.
